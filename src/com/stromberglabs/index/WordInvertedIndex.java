...
public class WordInvertedIndex {
	...
	public WordInvertedIndex(L1ImageWordIndex objidx, File directory){
		try {
			...
			//build the file index, this contains an internal file id -> name mapping
			mFidx = new FileIndex(objidx,directory);
			System.out.println("File index created");
			//build the word index, which is a word id -> list of file ids and counts
...
//		try {
//			WordInvertedIndex idx = new WordInvertedIndex("D:\\small\\web-index\\");
//			for ( int i = 0; i < idx.mFidx.getNumFiles(); i++ ){
//				System.out.println(idx.mFidx.getFilename(i));
//			}
//			for ( int i = 0; i < idx.mFidx.getNumFiles(); i++ ){
//				System.out.println(idx.mWidx.getDocument(i));
//			}
//		} catch (IOException e) {
